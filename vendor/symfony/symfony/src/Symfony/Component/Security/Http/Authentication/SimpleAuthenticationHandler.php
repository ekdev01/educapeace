...
class SimpleAuthenticationHandler implements AuthenticationFailureHandlerInterface, AuthenticationSuccessHandlerInterface
{
     ...
     * @param AuthenticationSuccessHandlerInterface $successHandler Admin success handler
     * @param AuthenticationFailureHandlerInterface $failureHandler Admin failure handler
