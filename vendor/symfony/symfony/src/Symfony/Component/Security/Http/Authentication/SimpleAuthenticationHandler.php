...
class SimpleAuthenticationHandler implements AuthenticationFailureHandlerInterface, AuthenticationSuccessHandlerInterface
{
     ...
     * @param AuthenticationSuccessHandlerInterface $successHandler Home success handler
     * @param AuthenticationFailureHandlerInterface $failureHandler Home failure handler
