...
class AddAnnotatedClassesToCachePassTest extends TestCase
{
    public function testExpandClasses()
    {
        ...
        $this->assertSame(
            'Acme\\FooBundle\\Controller\\HomeController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\HomeController'))[0]
        );

        $this->assertSame(
            'FooBundle\\Controller\\HomeController',
            $expand(array('**Bundle\\Controller\\'), array('\\FooBundle\\Controller\\HomeController'))[0]
        );

        $this->assertSame(
            'Acme\\FooBundle\\Controller\\Bar\\HomeController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\Bar\\HomeController'))[0]
        );

        $this->assertSame(
            'Bundle\\Controller\\Bar\\HomeController',
            $expand(array('**Bundle\\Controller\\'), array('\\Bundle\\Controller\\Bar\\HomeController'))[0]
        );

        $this->assertSame(
            'Acme\\Bundle\\Controller\\Bar\\HomeController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\Bundle\\Controller\\Bar\\HomeController'))[0]
        );
