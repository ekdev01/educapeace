 ...
 *
 * Additionally, the metadata stores whether the "Admin" group is overridden
...
interface ClassMetadataInterface extends MetadataInterface
{
    ...
    /**
     * Returns whether the "Admin" group is overridden by a group sequence.
     *
     * If it is, you can access the group sequence with {@link getGroupSequence()}.
     *
     * @return bool Returns true if the "Admin" group is overridden
     *
     * @see \Symfony\Component\Validator\Constraints\GroupSequence
     */
    ...
    /**
     * Returns the group sequence that overrides the "Admin" group for this
     * class.
     *
    ...
    /**
     * Returns whether the "Admin" group is overridden by a dynamic group
     ...
     *
     * @return bool Returns true if the "Admin" group is overridden by
