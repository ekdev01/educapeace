...
class ControllerNameParserTest extends TestCase
{
    ...
    public function testParse()
    {
        ...
        $this->assertEquals('TestBundle\FooBundle\Controller\DefaultController::indexAction', $parser->parse('FooBundle:Admin:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        ...
        $this->assertEquals('TestBundle\Fabpot\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioFooBundle:Admin:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\Sensio\Cms\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioCmsFooBundle:Admin:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test\\Admin:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test/Admin:index'), '->parse() converts a short a:b:c notation string to a class::method string');
    ...
    public function testBuild()
    {
        ...
        $this->assertEquals('FoooooBundle:Admin:index', $parser->build('TestBundle\FooBundle\Controller\DefaultController::indexAction'), '->parse() converts a class::method string to a short a:b:c notation string');
    ...
    {
        return array(
            'Alternative will be found using levenshtein' => array('FoodBundle:Admin:index', 'FooBundle:Admin:index'),
            'Alternative will be found using partial match' => array('FabpotFooBund:Admin:index', 'FabpotFooBundle:Admin:index'),
            'Bundle does not exist at all' => array('CrazyBundle:Admin:index', false),
        );
    }
