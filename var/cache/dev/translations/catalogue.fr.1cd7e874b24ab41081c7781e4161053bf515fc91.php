...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'menu_shop' => 'Boutique solidaire',
    'menu_contact' => 'Contact',
    'menu_members_area' => 'Espace adhérents',
    'label.title.1' => 'Educapeace',
    'label.title.2' => 'Association Educapeace',
    'label.title.3' => 'Notre équipe',
    'label.title.4' => 'L\'histoire d\'Educapeace',
    'label.title.5' => 'Educapeace France',
    'label.title.6' => 'Educapeace Cameroun',
    ...
    'form.supportus.intro1' => 'Je fais un don',
    'form.supportus.intro2' => 'pour les enfants du monde',
    ...
    'form.rules.title1' => 'SÉLECTIONNEZ VOTRE CARTE DE PAIEMENT',
    'form.rules.numcard' => 'Saisissez votre numéro de carte',
    'form.rules.date1' => 'date',
    'form.rules.date2' => 'd\'expiration',
    'form.rules.codesecurity' => 'Code de sécurité',
    'form.rules.submit' => 'Je donne',
    'form.rules.avis' => 'OU FAIRE UN PAIEMENT PAR PAYPAL',
    'form.rules.title2' => 'FAIRE UN PAIEMENT PAR IBAN/BIC',
    'form.rules.iban' => 'Votre numéro iban',
    'form.rules.bic' => 'Votre code bic',
    ...
    'label.shop.title' => 'Boutique solidaire',
    'label.shop.1' => 'La boutique solidaire EDUCAPEACE vous propose de nombreux produits solidaires en ligne:',
    'label.shop.2' => 'pâtisserie, jus de gingembre, jus de Bissap, tenue Africaine, colliers, objets d’arts, etc.',
    'label.shop.3' => 'Vos achats ont du sens et nous donnent les moyens d\'agir.',
    'label.shop.4' => 'Pour en savoir plus...',
    'label.history.1' => '« Pour créer cette association qui est vôtre, je me suis basé sur mon passé. Mon cursus scolaire (primaire) s\'est passé à l’école publique de Nkol-Mbong Kama, au Sud du Cameroun. A cause du manque de moyens financiers, j\'ai eu d\'énormes problème par rapport aux études et à la santé.  Ayant quitté mon pays le Cameroun il y a de cela une dizaine d\'années, je me suis construit en apprenant pour mon avenir, pour les plus jeunes, pour les démunis ». Ainsi, est née l\'association Educapeace.',
    'label.history.2' => 'Educapeace est en partenariat avec des écoles publiques au Cameroun (4 pour le moment) où chaque année nous offrons des bourses d\'excellence, et fournitures scolaires aux enfants afin de les encourager à aller à l\'école. Chaque année nous aidons plus de 600 enfants, et à ce jour nous avons déjà construit deux puits d\'eau potable.',
    'label.history.3' => 'Ensemble nous souhaitons donner encore plus de sourire aux enfants, leurs permettre d\'aller à l\'école car nous avons compris la valeur/puissance de l\'école, puis leur permettre d\'accéder aux équipements tels que l\'eau potable, latrines, bibliothèque … Afin d\'améliorer leurs conditions de vie, diminuer le taux d\'absentéisme scolaire, de maladies hydriques voir même de mortalité.',
  ),
  'FOSUserBundle' => 
  array (
