...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/a')) {
            // page_adhesion
            if ('/adhesion' === $pathinfo) {
                return array (  '_controller' => 'EK\\AssoBundle\\Controller\\Front\\AdhesionController::indexAction',  '_route' => 'page_adhesion',);
            }

            // admin_home_page
            if ('/admin' === $trimmedPathinfo) {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($rawPathinfo.'/', 'admin_home_page');
                }

                return array (  '_controller' => 'EK\\AssoBundle\\Controller\\Backend\\AdminController::indexAction',  '_route' => 'admin_home_page',);
            }

            // about_page
            if ('/about' === $pathinfo) {
                return array (  '_controller' => 'EK\\AssoBundle\\Controller\\Front\\HomeController::aboutAction',  '_route' => 'about_page',);
            }
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($rawPathinfo.'/', 'home_page');
            }

            return array (  '_controller' => 'EK\\AssoBundle\\Controller\\Front\\HomeController::indexAction',  '_route' => 'home_page',);
        }

        // news_page
        if ('/news' === $pathinfo) {
            return array (  '_controller' => 'EK\\AssoBundle\\Controller\\Front\\HomeController::newsAction',  '_route' => 'news_page',);
        }

        // contact_page
        if ('/contact' === $pathinfo) {
            return array (  '_controller' => 'EK\\AssoBundle\\Controller\\Front\\HomeController::contactAction',  '_route' => 'contact_page',);
        }

        // shop_page
        if ('/shop' === $pathinfo) {
            return array (  '_controller' => 'EK\\AssoBundle\\Controller\\Front\\ShopController::indexAction',  '_route' => 'shop_page',);
        }
